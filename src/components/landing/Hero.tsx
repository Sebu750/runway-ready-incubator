...
export function Hero() {
  return (
    <section id="top" className="relative min-h-[100svh] w-full overflow-hidden grain">
      ...
      {/* Headline */}
      <div className="relative z-10 px-6 md:px-10 mt-12 sm:mt-20 md:mt-32 pb-24 md:pb-32">
        <div className="mx-auto max-w-[1400px]">
          <h1 className="display text-balance text-[clamp(2.25rem,11vw,9rem)] leading-[0.88] uppercase">
            Stop interning.
            <br />
